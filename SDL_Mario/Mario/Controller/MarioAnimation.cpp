...
SDL_Texture* MarioAnimation::animateStand()
{
    ...
    switch(marioType)
    {
        ...
        default:
            std::cout << "Ni ma animateStand() w MarioAnimation" << std::endl;
...
SDL_Texture* MarioAnimation::animateWalk()
{
    ...
    switch(marioType)
    {
        ...
        default:
            std::cout << "This error doesn't make sense, catch an exception :)" << std::endl;
            throw *(new std::exception);
    }
}
...
SDL_Texture* MarioAnimation::animateJump()
{
    ...
    switch(marioType)
    {
        ...
        default:
            std::cout << "Ni ma animateJump() w MarioAnimation" << std::endl;
            throw *(new std::exception);
    }
}
...
SDL_Texture* MarioAnimation::animateSquat()
{
    ...
    switch(marioType)
    {
        ...
        default:
            std::cout << "animateSquat()" << std::endl;
            throw *(new std::exception);
    }
}
...
SDL_Texture* MarioAnimation::animateClimb()
{
    ...
    switch(marioType)
    {
        ...
        default:
            std::cout << "animateClimb()" << std::endl;
            throw *(new std::exception);
    }
}
